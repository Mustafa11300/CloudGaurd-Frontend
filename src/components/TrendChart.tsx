    ...
    <div className="h-56">
      <ResponsiveContainer>
        <LineChart data={chartData}>
          ...
          <YAxis domain={[40, 100]} tick={{ fontSize: 10, fill: "hsl(215, 20%, 55%)" }} axisLine={false} tickLine={false} width={30} />
          <Tooltip
            contentStyle={{
          ...
          />
          <Line type="monotone" dataKey="score" stroke="hsl(160, 84%, 39%)" strokeWidth={2} dot={false} />
          <Line type="monotone" dataKey="cost" stroke="hsl(199, 89%, 48%)" strokeWidth={2} dot={false} />
        </LineChart>
      </ResponsiveContainer>
    </div>
  </div>
