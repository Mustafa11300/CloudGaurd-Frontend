...
import { getTopFindings, type Finding } from "@/data/api";
    ...
    <div className="max-w-7xl mx-auto space-y-6">
      <div className="flex flex-col gap-1">
        ...
        <p className="text-muted-foreground">
          {loading ? "Loading..." : `${findings.length} findings across all resource types.`}
        </p>
      </div>
      ...
      {/* Loading state */}
      {loading ? (
        <div className="border border-border rounded-md p-12 text-center text-muted-foreground text-sm">
          Loading findings from Elasticsearch...
        </div>
      ) : (
          ...
          <table className="w-full">
            <thead>
              <tr className="bg-secondary/50 border-b border-border">
                <th className="text-left text-[10px] font-mono uppercase tracking-wider text-muted-foreground px-4 py-3">
                  Severity
                </th>
                <th className="text-left text-[10px] font-mono uppercase tracking-wider text-muted-foreground px-4 py-3">
                  Finding
                ...
                <th
                  className="text-left text-[10px] font-mono uppercase tracking-wider text-muted-foreground px-4 py-3 cursor-pointer select-none"
              ...
              {filtered.map((f) => (
                <>
                  ...
                  >
                    ...
                    <td className="px-4 py-3 text-sm font-mono text-foreground" data-metric>
                      {f.risk_score}/100
                    </td>
                  </tr>
